...
auth.set_access_token(TWITTER_ACSESS_TOKEN, TWITTER_ACSESS_TOKEN_SECRET)
...
if tabs == 'Credits':
    ...
    st.write("Contact: You can email me at faizstock@gmail.com or message me on Linkdin at this [link](www.linkedin.com/in/faiz-bhimji)")
    st.subheader("The Data: ")
    st.write("I scraped information about stocks off of Twitter, Yahoo, Google, StockTwits, and imported data from various sources listed in my GitHub here [link]().")
