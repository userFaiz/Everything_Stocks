            ...
            if rel:
                ...
                for item in list_of_articles:
                    try:
                        ...
                        st.write("Published On: " + str(published[0:4])+ str(published[6:10]) ", Time: " + str(published[11:16]))
