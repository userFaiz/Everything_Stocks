...
if tabs == 'Credits':
    ...
    st.write("I scraped information about stocks off of Twitter, Yahoo, Google, StockTwits, and imported data from various sources listed in my GitHub here [link](https://github.com/userFaiz/Everything_Stocks).")
